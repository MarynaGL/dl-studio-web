...
export default function ServiceQA() {
  // Inicializamos el traductor apuntando a la sección QA
  const t = useTranslations('Servicios.QA');
    ...
    <section id="qa" className="w-full flex justify-center bg-[#F7F7F7] py-20 overflow-hidden">
      ...
      <div className="w-full max-w-[1440px] px-8 lg:px-[60px] flex flex-col">
        ...
        <div className="w-full bg-[#e4e4e4] p-10 lg:pt-16 lg:px-16 lg:pb-8 flex flex-col relative">
          ...
          {/* FLECHA REUTILIZABLE: Centrada debajo de todo */}
          <ScrollUpArrow />
