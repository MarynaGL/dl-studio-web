...
import ScrollUpArrow from './ScrollUpArrow'; // Importamos la flecha
          ...
          <div className="flex flex-col gap-12">
            <div>
              ...
              <button 
                ...
                className={`block text-[14px] font-medium mb-1 transition-colors text-left ${selectedCity === 'BA' ? 'text-[#6b9e7a]' : 'text-[#18181A] hover:text-[#6b9e7a]'}`}
              >
              ...
              <button 
                ...
                className={`block text-[14px] font-medium transition-colors text-left ${selectedCity === 'LV' ? 'text-[#6b9e7a]' : 'text-[#18181A] hover:text-[#6b9e7a]'}`}
              >
