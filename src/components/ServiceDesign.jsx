...
export default function ServiceDesign() {
  // Conectamos con el bloque Servicios.Diseno de tus archivos JSON
  const t = useTranslations('Servicios.Diseno');
  ...
  return (
    <section id="diseno" className="w-full flex justify-center bg-[#f8f8f6] py-20 overflow-hidden">
      ...
      <div className="w-full max-w-[1440px] px-8 lg:px-[60px] flex flex-col">
        ...
        {/* ========================================= */}
        {/* METODOLOGÍA (3 COLUMNAS)                  */}
        {/* ========================================= */}
        <div className="mb-20">
          <div className="flex items-center gap-2 mb-12">
            <span className="text-[14px] font-inter font-light text-[#939390]">{t('metodologia_tag')}</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-[#939390]/30 border-y border-[#939390]/30">
            ...
            <div className="flex flex-col p-8 lg:p-12">
              ...
              <h4 className="text-[16px] font-inter font-bold text-[#18181A] mb-6">{t('metodologia.paso2_tit')}</h4>
              <p className="text-[14px] font-inter font-light text-[#939390] leading-relaxed">
                {t('metodologia.paso2_desc')}
              </p>
            </div>
            ...
            <div className="flex flex-col p-8 lg:p-12 lg:pr-0">
              ...
              <h4 className="text-[16px] font-inter font-bold text-[#18181A] mb-6">{t('metodologia.paso3_tit')}</h4>
              <p className="text-[14px] font-inter font-light text-[#939390] leading-relaxed">
                {t('metodologia.paso3_desc')}
              </p>
            </div>
        ...
        <div className="w-full bg-[#e4e4e4] p-10 lg:pt-16 lg:px-16 lg:pb-8 flex flex-col relative">
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-0 w-full">
            ...
            <div className="w-full lg:w-1/2 flex flex-col pr-0 lg:pr-16">
              <span className="text-[14px] font-inter font-light text-[#939390] mb-6">{t('auditoria_tag')}</span>
              <h4 className="text-[18px] font-inter font-bold text-[#18181A] mb-6">{t('auditoria_tit')}</h4>
              <p className="text-[14px] font-inter font-light text-[#939390] leading-relaxed">
                {t('auditoria_desc')}
              </p>
            </div>
