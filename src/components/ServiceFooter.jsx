  ...
  return (
    ...
    <section id="punta-a-punta" className="w-full flex justify-center bg-[#F7F7F7] py-20 overflow-hidden">
      ...
      <div className="w-full max-w-[1440px] px-4 md:px-8 lg:px-[60px] relative">
        ...
        {/* ========================================= */}
        {/* MAGIA AQUÍ: Agregamos mx-auto al lado de max-w-[1079px] para centrarla */}
        <div className="w-full max-w-[1079px] mx-auto bg-[#404040] pt-24 px-10 pb-12 lg:px-20 flex flex-col items-center text-center relative">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8">
            ...
            <Link 
              href="/contacto#contacto-form" 
              className="bg-[#6b9e7a] text-white font-inter font-medium text-[16px] py-4 px-8 rounded hover:bg-[#5a8667] transition-colors"
            >
              {t('btn_conversacion')}
            </Link>
